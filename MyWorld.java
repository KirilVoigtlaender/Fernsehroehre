...
public class MyWorld extends World
{
    ...
    {    
        ...
        addObject(new Magnet(new Vektor(0,0,1),140,20,"senkrecht","up","down",30),600,400);
        addObject(new Magnet(new Vektor(0,1,0),140,50,"waagerecht","right","left",30),600,400);
    }
